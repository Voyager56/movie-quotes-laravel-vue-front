    ...
    <div class="flex justify-between w-[300px] items-center">
      <div class="relative">
        ...
        <div
          :class="
            notificationModal
              ? `bg-[#22203033]/70 left-0 right-0 top-[5rem] bottom-0 absolute z-10 backdrop-blur-sm`
              : ''
          "
        >
          <div
            class="fixed bg-[#000000] text-white right-[100px] top-[100px] h-[100px] w-[500px] flex flex-col justify-evenly items-start px-5 rounded-xl"
