<template>
  <div class="flex flex-col items-center h-screen md:px-10 md:py-10 :mx-20">
    ...
    >
      <div class="bg-[#262242] px-5 py-2 flex flex-col rounded-xl items-center">
        <div
        ...
        >
          ...
          <input
            ...
            type="file"
            name="image"
            class="absolute w-fit top-[50px] left-0 h-[50px] text-[100%] rounded-full"
            @change="imageUpload"
          />
        </div>
        ...
        <div class="flex flex-col my-2">
          ...
          <Field
            ...
            name="username"
            rules="required"
            class="bg-white text-black my-2 border-[#6C757D] border-[2px] px-3 py-2 rounded-md md:w-[400px]"
