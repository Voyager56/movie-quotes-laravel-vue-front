...
<template>
    <div class="flex items-center relative cursor-pointer z-10" @click="toggle">
        ...
        <IconArrow class="pl-2 w-5 transition-transform p-0 "
            :class="dropDown ? `rotate-0 ` : `rotate-90 absolute top-[4px] right-[-20px] w-5`" />
        <div class="absolute bg-red-500 top-[30px] text-white left-[-40px] h-[100px] flex flex-col justify-evenly px-5 rounded-xl"
